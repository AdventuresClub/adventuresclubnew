...
import 'package:app/widgets/Lists/Chat_list.dart/adventure_chat.dart';
import 'package:app/widgets/Lists/Chat_list.dart/show_chat.dart';
import 'package:app/widgets/Lists/adventure_chat_vendorlist.dart';
  ...
  void selected() {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) {
          return ShowChat(
              "${Constants.baseUrl}/receiverlist/${Constants.userId}/${widget.serviceId}");
        },
      ),
    );
  }
