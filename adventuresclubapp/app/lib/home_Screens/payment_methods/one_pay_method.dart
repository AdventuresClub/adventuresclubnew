...
import 'package:app/home_Screens/accounts/international_visa_card_details.dart';
import 'package:app/widgets/my_text.dart';
import 'package:flutter/material.dart';

class OnePayMethod extends StatefulWidget {
  const OnePayMethod({super.key});

  @override
  State<OnePayMethod> createState() => _OnePayMethodState();
}

class _OnePayMethodState extends State<OnePayMethod> {
  List images = [
