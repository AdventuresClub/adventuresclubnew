...
import 'package:app/home_Screens/accounts/become_a_partner_screen2.dart';
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(children: [
              ...
              TFWithSize(
                  'Enter Comany Name', controller, 12, lightGreyColor, 1),
              const SizedBox(height: 20),
              Align(
                alignment: Alignment.centerLeft,
                child: MyText(
              ...
              const SizedBox(height: 10),
              TFWithSize(
                  'Enter Official Address', controller, 12, lightGreyColor, 1),
              const SizedBox(height: 20),
              Align(
                alignment: Alignment.centerLeft,
                child: MyText(
              ...
              const SizedBox(height: 10),
              TFWithSize(
                  'Enter GeoLocation', controller, 12, lightGreyColor, 1),
              const SizedBox(height: 20),
              Align(
                alignment: Alignment.centerLeft,
                child: MyText(
              ...
              ButtonIconLess(
                  'Next', bluishColor, whiteColor, 1.8, 16, 16, goToBPS2)
            ]),
          ),
        ));
  }
