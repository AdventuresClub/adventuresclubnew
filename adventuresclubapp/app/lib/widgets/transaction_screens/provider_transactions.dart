...
//           constraints: BoxConstraints(
//             maxHeight:
//                 MediaQuery.of(context).size.height * 0.5, // Adjust this value
//           ),
//           child: ListView(
//             children: [
...
class ProviderTransactionsState extends State<ProviderTransactions> {
  ...
  Widget _buildDataTableWidget() {
    return Column(
      children: [
        ...
        // DataTable - Now with proper scrolling
        Expanded(
          child: _buildScrollableDataTable(),
        ),
  ...
  //         ),
  //         SizedBox(height: 8),
  //         // Alternative: Use Row with Flexible for responsive layout
  //         Row(
  //           children: [
  //             Flexible(
  //               flex: 2,
  ...
  //         ),
  //         SizedBox(height: 8),
  //         // LayoutBuilder provides the parent constraints
  //         LayoutBuilder(
  ...
  //                 SizedBox(
  //                   width:
  //                       constraints.maxWidth * 0.65, // 65% of available width
  //                   child: DropdownButtonFormField<String>(
  //                     value: _statusFilter,
  //                     decoration: InputDecoration(
  //                       labelText: 'Settlement Status'.tr(),
  ...
  //                 SizedBox(
  //                   width: constraints.maxWidth * 0.3, // 30% of available width
  //                   child: DropdownButtonFormField<int>(
  //                     value: _rowsPerPage,
  //                     decoration: InputDecoration(
  //                       labelText: 'Rows'.tr(),
  ...
  // Fixed: Properly scrollable data table both horizontally and vertically
  Widget _buildScrollableDataTable() {
    return Container(
      margin: EdgeInsets.symmetric(horizontal: 8),
      child: Card(
