        ...
        if (element['category'] == "Accomodation") {
          ...
          t.forEach((tServices) {
            ...
            ServicesModel tServicesModelList = ServicesModel(
              ...
              tServices['service_category_image'] ?? "",
              tServices['service_sector_image'] ?? "",
              tServices['service_type_image'] ?? "",
              tServices['service_level_image'] ?? "",
          ...
          skyList.forEach((skyServices) {
            ...
            ServicesModel skyServicesModelList = ServicesModel(
              ...
              skyServices['service_category_image'] ?? "",
              skyServices['service_sector_image'] ?? "",
              skyServices['service_type_image'] ?? "",
              skyServices['service_level_image'] ?? "",
          ...
          waterList.forEach((waterServices) {
            ...
            ServicesModel waterServicesModelList = ServicesModel(
              ...
              waterServices['service_sector_image'] ?? "",
              waterServices['service_type_image'] ?? "",
              waterServices['service_level_image'] ?? "",
          ...
          landList.forEach((landServices) {
            ...
            ServicesModel landServicesModelList = ServicesModel(
              ...
              landServices['service_sector_image'] ?? "",
              landServices['service_type_image'] ?? "",
              landServices['service_level_image'] ?? "",
          ...
          other.forEach((otherElement) {
            ...
            ServicesModel otherModelList = ServicesModel(
              ...
              otherElement['service_sector_image'] ?? "",
              otherElement['service_type_image'] ?? "",
              otherElement['service_level_image'] ?? "",
