    ...
    Container(
        decoration:  BoxDecoration(
           image: DecorationImage(
              colorFilter:  ColorFilter.mode(blackColor.withOpacity(0.4), BlendMode.darken),
                ...
                child: Text(
                   ...
                   textAlign:TextAlign.center,
                    style: TextStyle(
                        ...
                        fontSize: 22, color: Colors.white, height: 1.3,fontFamily: 'Raleway',)),
              ),
              SizedBox(height:2)
            ],
          ),
    ...
    return Scaffold(
      ...
      child: Stack(
        children: [
          Padding(
            ...
            child: PageView.builder(
              ...
              bottom: 50,
              right: 40,
              child: Button('Get Started', whiteColor, whiteColor ,blackColor, 18, goToSignUp, Icons.add, whiteColor, false, 1.3,'Raleway',FontWeight.w600,16),
       ),
        Positioned(
        bottom:15,
        left:75,
        child:GestureDetector(
          ...
          TextSpan(
            children: [
              TextSpan(text: 'Already have an account ?',style: TextStyle(color:whiteColor,fontFamily: 'Raleway',)),
              TextSpan(
          text: 'Sign In',
          style: TextStyle(fontWeight: FontWeight.bold, color: whiteColor,fontFamily: 'Raleway',),
              ),
            ],
          ),
        ),
