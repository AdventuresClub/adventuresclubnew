                      ...
                      children: [
                       ...
                       Stack(
                        ...
                        left:MediaQuery.of(context).size.width/3.9,
                          ...
                          child: ButtonIconLess('View Tour Details', bluishColor, whiteColor, 2.5, 17, 14, abc)),
                        ...
                        child: Column(
                          children: [
                            Row(
                              ...
                              children: [
                              MyText(text: 'Wadi Haver',color: blackColor,size: 16,weight: FontWeight.w500,),
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                MyText(text: '20,000',color: greyColor,size: 16,weight: FontWeight.w500,),
