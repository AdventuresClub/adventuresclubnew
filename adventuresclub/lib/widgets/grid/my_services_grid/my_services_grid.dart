                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                              MyText(text: 'Hill Climbing',color: blackColor,size: 12,weight: FontWeight.w500,fontFamily: 'Roboto',),
                              const SizedBox(width:5),
                               MyText(text: '09 April, 2020',color: greyColor,size: 9,),
