...
class _PaymentState extends State<Payment> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      actions: [const Image(image: ExactAssetImage('images/edit.png'),width: 25,height: 25,),
        ...
        child: Padding(
          ...
          child: Column(children: [
              ListTile(
                ...
                title: MyText(text: 'Saved Card',color: greyColor,),
              visualDensity: const VisualDensity(horizontal: 0 ),
              subtitle: MyText(text: 'Select to payment default',color: greyColor,size: 12,),
                ...
                children:  [
                  Container(
                    ...
                    child: TextField(decoration: InputDecoration(
                      ...
                      suffixIcon: const Image(image: ExactAssetImage('images/masterCard.png'),height: 20,width: 20,),
              ...
              borderSide: BorderSide(color: greyColor.withOpacity(0.5)),
                ...
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(32)),
                  ...
                  Align(alignment: Alignment.centerLeft,
                       child: MyText(text: 'Add new Card',color: greyColor,size: 18,),
                       ),
