    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          title: MyText(text: 'My Adventures',color: bluishColor,),
      ...
      const SizedBox(width: 15,),
                            Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    MyText(text: 'Lorem Ipsum',weight: FontWeight.w700,color: blackColor,size: 18,),
                                const SizedBox(width: 20,),
                                    MyText(text: '20 May - 25 May',weight: FontWeight.w400,color: greyColor,size: 12,),
                     ...
                     const SizedBox(height: 20,),
                       Align(alignment: Alignment.centerLeft,
                                     child: MyText(text: 'How was your experience there',color: blackColor,size: 18,weight: FontWeight.bold,),
                                     ),
                                       const SizedBox(height: 20,),
                                 Container(
                                  width: MediaQuery.of(context).size.width/1.1,
                                  decoration: BoxDecoration(color: whiteColor,borderRadius:BorderRadius.circular(12),border: Border.all(color: blackColor.withOpacity(0.2)) ),
                                ...
                                onRatingUpdate: (rating) {
                                    print(rating);
                                     ...
                                     const SizedBox(height: 20,),
                                     const MultiLineField('Description', 5,whiteColor),
