    ...
    return Scaffold(
      backgroundColor: greyProfileColor,
        ...
        leading: IconButton(
          ...
          title: MyText(text: 'Privacy Policy',color: bluishColor,),
      ...
      body:ListView(
        ...
        children: [
          MyText(text: '1 Cybersecurity should underpin digital payment infrastructures...',weight: FontWeight.w500,color: blackTypeColor1,),
             
             const SizedBox(height: 7,),
              MyText(text: 'As we come close to a year of being separated from or colleagues, friends, family, and conducting both our professional and personal lives through our laptops and phone screens - It is a good time to take a step back and re-evaluate the p',weight: FontWeight.w400,color: greyColor,),
              const Divider(color: blackTypeColor3,),
      MyText(text: 'Tapping into the data boom with DBaaS',weight: FontWeight.w500,color: blackTypeColor1,size: 14,),
             
             const SizedBox(height: 7,),
              MyText(text: 'MultiCloud is here to stay and is slowly becoming inevitable for many organizations. At the same time, it is important to go beyond the hype of the buzzword and undestand where it can help, and where it cannot. One of the common benef',weight: FontWeight.w400,color: greyColor,),
              const Divider(color: blackTypeColor3,),
