  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      return const  ContactUs();
                      ...
                      leading: MyText(text: text[index],color: blackColor.withOpacity(0.7),weight: FontWeight.w500,size: 14,),
        ...
        title: MyText(text: countryName,color: blackColor.withOpacity(0.7),size: 14,weight: FontWeight.w500,),
         trailing:SizedBox(
          ...
          child: Row(
            ...
            children: [
            MyText(text: 'Oman',color: blackTypeColor3,),
            const Icon(Icons.arrow_drop_down,color: bluishColor,)
          ],))
  ...
  return   ListTile(
                                            ...
                                            return Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Center(
                                                    child: MyText(text:pickLanguage[index],size:14,color:blackTypeColor4),
        ...
        trailing:SizedBox(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
            MyText(text: 'Eng',color: blackTypeColor3,),
            const Icon(Icons.arrow_drop_down,color: bluishColor,)
          ],)) 
