   ...
   showDialog(
        ...
        builder: (context) {
            ...
            child:Padding(
              ...
              child: Column(
                ...
                children: [
                 ...
                 const Image(image: ExactAssetImage('images/check_circle.png'),height: 25,),
              Padding(
          ...
          Padding(
            ...
            child: Button('Okay ,Got it', greenishColor, greyColorShade400 ,whiteColor, 16, goToBottomNavigation, Icons.add, whiteColor, false, 1.3,'Raleway',FontWeight.w600,16),
          ),
...
contentPadding:const EdgeInsets.symmetric(vertical: 8,horizontal: 8),
                        ...
                        suffixIcon: const Image(image: ExactAssetImage('images/map-symbol.png'),height: 15,width: 20,),
                ...
                borderSide: BorderSide(color: greyColor.withOpacity(0.2)),
                      ...
                      const SizedBox(height: 20,),
                       TFWithSize('Type Specific Address/Location', controller, 15, lightGreyColor, 1),

                       const Divider(),
                          Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,  
                children: [
                  TFWithSize('Set Cost', controller, 16, lightGreyColor, 3.4,),
                  TFWithSize('Set Cost', controller, 16, lightGreyColor, 3.4,),
                  const DdButton(5.5)
              ...
              const SizedBox(height:15),
                       ...
                       child:MyText(text:'Terms and conditions',color: blackTypeColor,weight: FontWeight.w500,)
                       ),
                       const SizedBox(height:20),
              ...
              MultiLineField('Type Minimum Requirement....', 5, lightGreyColor),
                       ...
                       const SizedBox(height:20),
              MultiLineField('Type Terms & Conditions.....', 5, lightGreyColor),
