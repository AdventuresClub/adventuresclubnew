      ...
      children: [
        ...
        const SizedBox(height:20),
            ...
            Row(
              ...
              children: [
                TFWithSizeImage('Start Date', controller, 16, lightGreyColor, 2.4,Icons.calendar_month_outlined,bluishColor),
                TFWithSizeImage('End Date', controller, 16, lightGreyColor, 2.4,Icons.access_time,bluishColor),
              ],
            ),
             const SizedBox(height:20),
            Row(
              ...
              children: [
                TFWithSize('Schedule Description', controller, 12, lightGreyColor, 1.4),
         ...
         const SizedBox(width: 5,),
          MyText(text: 'Add More Schedule',color: bluishColor,)
        ],),
       const SizedBox(height:20),
      ],
    );
